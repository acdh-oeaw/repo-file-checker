...
$parser->addArgument('--blackList', nargs: ArgumentParser::NARGS_REQ, default: $blacklist, help: "Extenstions of files to be skipped (default: [%(default)s])");
...
$ret = $ch->check($args->directoryToCheck, $args->outputMode);
exit($ret ? 0 : 2);
